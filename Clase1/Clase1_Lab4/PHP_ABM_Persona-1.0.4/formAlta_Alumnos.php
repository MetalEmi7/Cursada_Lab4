...
?>
	...
	<div class="container">
		...
		<div class="CajaInicio animated bounceInRight">
			...
			<form id="FormIngreso" method="post" action="formAlta_Alumnos.php" enctype="multipart/form-data" >
				...
				<input type="hidden" name="idOculto" id="idOculto" value="<?php echo isset($unaPersona) ? $unaPersona->GetId() : "" ; ?>" />	
				

				<?php echo isset($unaPersona) ? 	"<p style='color: black;'>*El ID no se puede modificar.</p> ": "" ; ?>		

				
				<a class="btn btn-info " name="guardar" onclick="Validar_Alumno()" ><span class="glyphicon glyphicon-save">&nbsp;</span>Guardar</a>
