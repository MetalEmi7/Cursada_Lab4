                ...
                <h1>ABM - con archivo de texto Versión 1.0.2 Con foto</h1>      
					...
					<div class="CajaInicio animated bounceInRight">
							...
							<form id="FormIngreso">
									    ...
									    <a href="formAlta_Alumnos.php" class="list-group-item  list-group-item list-group-item-info">
									      <h4 class="list-group-item-heading">Alta de Alumnos</h4>
									    </a>
									    									
										<a href="formGrilla_alumnos.php" class="list-group-item  list-group-item list-group-item-info">
